...
const proposals: Proposal[] = [
  ...
  },
  {
    ...
    fullDescription: "This proposal reduces the liquidation bonus from 5% to 4%. Analysis of historical liquidation events on Stelo testnet shows that the current 5% bonus, while effective at incentivizing liquidators, contributes to cascading liquidations during high-volatility periods.\n\nWhen a large position is liquidated at 5%, the resulting market impact can push other positions below their liquidation thresholds, creating a chain reaction. Reducing the bonus to 4% maintains sufficient incentive for liquidators while reducing the severity of cascading events.\n\nComparative analysis: Aave V3 uses 4-6.5% depending on the asset. A uniform 4% on Stelo is conservative and appropriate for the current market depth.\n\nThe change would apply to all collateral types simultaneously. No per-asset differentiation is proposed at this time.",
    status: "passed",
    forVotes: 2100000,
    againstVotes: 450000,
    endDate: "Ended",
